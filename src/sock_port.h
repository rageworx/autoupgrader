...
#include <stdarg.h>
    ...
    #ifndef NEED_SHORT_TYPES
        #define NEED_SHORT_TYPES 1
    #endif

    #ifndef NEED_WINDOWS_POLL
        #ifdef POLLIN
            #define NEED_WINDOWS_POLL 0
        #else
    ...
    #ifndef NEED_HSTRERROR
        #define NEED_HSTRERROR 1
    #endif

    #ifndef NEED_GETLASTERROR
        #define NEED_GETLASTERROR 1
    #endif

    #ifndef NEED_FIREWALL_ENABLE
    ...
    #ifndef NEED_CLOSESOCKET
        #define NEED_CLOSESOCKET 1
    #endif

    #ifndef NEED_IOCTLSOCKET
